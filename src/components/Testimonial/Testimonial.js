            ...
            <Slider {...settings}>
              {Testimonials.map((e, key) => {
                return (
                  <div
                    key={key}
                    className="!flex border-2 border-slate-900 md:p-9 p-5 hover:shadow-black transition-all duration-300 ease-in"
                  >
                    ...
                    <div className="relative flex-1 pl-5">
                      <p className="mb-3 text-[17px] text-slate-700/90">
                        {e.Detail}
                      </p>
